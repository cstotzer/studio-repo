...
/* Create the graph with the SGPLOT procedure.  */
/* Each SERIES statement produces a line and the */
/* NEEDLE statement produces the needle in the graph. */
proc sgplot data=yield cycleattrs;
   ...
   needle x=matcur y=yldcur / lineattrs=graphreference;
